...
public class UserDashboard {
	...
	/*
	 * private void tryToGetUserProfile(ModelAndView mv) { String endpoint =
	 * "http://localhost:8081/api/profile"; try { UserProfile userProfile =
	 * restTemplate.getForObject(endpoint, UserProfile.class);
	 * mv.addObject("profile", userProfile); } catch (HttpClientErrorException e) {
